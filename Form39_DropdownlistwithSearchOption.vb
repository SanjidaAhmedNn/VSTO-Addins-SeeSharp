...
Public Class Form39_DropdownlistwithSearchOption
    ...
    Private Form As Form40 = Nothing
    ...
    Private Sub Form39_DropdownlistwithSearchOption_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    ...
    Private Sub sheet_SelectionChange(ByVal Target As Excel.Range)
        ...
        If GB_CB_Source3 IsNot Nothing Then
            src_rng = workSheet.Range(GB_CB_Source3)
    ...
    Private Sub Btn_OK_Click(sender As Object, e As EventArgs) Handles Btn_OK.Click
        ...
        Else
            ...
            If TB_src_rng.Enabled = True Then
                GB_CB_Source3 = TB_src_rng.Text 'SR is the global variable for Source Range
            Else
                GB_CB_Source3 = src_rng.Address
            End If
            ...
            RangeType3 = CB_Source.Text

            TType3 = ""
            SR3 = CB_Source.Text
            shName3 = workSheet.Name

            workSheet2.Range("A2").Value = GB_CB_Source3   'For Source Range
            workSheet2.Range("A3").Value = SR3             '  Range Type
            'workSheet2.Range("A4").Value = Horizontal2
            'workSheet2.Range("A5").Value = Separator2
            'workSheet2.Range("A6").Value = Search2
            workSheet2.Range("A7").Value = Flag3            'Activated
            workSheet2.Range("A8").Value = TargetVar3
            workSheet2.Range("A9").Value = shName3

            Me.Close()
        End If
    End Sub

    Private Sub GB_Sample_Enter(sender As Object, e As EventArgs) Handles GB_Sample.Enter

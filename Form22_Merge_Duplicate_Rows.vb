...
Public Class Form22_Merge_Duplicate_Rows
    ...
    End Function
    Private Function GetUniques(rng As Excel.Range, CaseSensitive As Boolean)
            ...
            If Active = True Then
                ...
                If CheckBox3.Checked = True Then
                    For i = 1 To cRng.Rows.Count
                        If cRng.Cells(i, 1).Value IsNot Nothing Then
                            If Search(Arr1, cRng.Cells(i, 1).Value, CaseSensitive) = False Then
                                Index1 = Index1 + 1
                                Index2 = Index2 + 1
                ...
                Dim UniQueArr() As Integer = GetUniques(displayRng, CaseSensitive)
                ...
                For j = 1 To displayRng.Columns.Count
                    If j <> PrimaryColumn Then
                        ...
                        For k = LBound(Arr1) To UBound(Arr1)
                            ...
                            For i = 1 To displayRng.Rows.Count
                                ...
                                If CheckBox6.Checked = True Then
                                    DuplicateCondition = SearchInArray(UniQueArr, i)
                                Else
                                ...
                                If displayRng.Cells(i, j).value IsNot Nothing And DuplicateCondition Then
                                    ...
                                    If CheckBox1.Checked = True Then
                                        Matched = displayRng.Cells(i, PrimaryColumn).value = Arr1(k)
                                    Else
                                        Matched = LCase(displayRng.Cells(i, PrimaryColumn).value) = LCase(Arr1(k))
                                    End If
                        ...
                        If labels3(j - 1).Text = "    Comma" Then
                            separator = ", "
                            widthFlag = True
                            Flag = "a"
                        ElseIf labels3(j - 1).Text = "    Colon" Then
                            separator = ": "
                            widthFlag = True
                            Flag = "a"
                        ElseIf labels3(j - 1).Text = "    Semicolon" Then
                            separator = "; "
                            widthFlag = True
                            Flag = "a"
                        ElseIf labels3(j - 1).Text = "    Space" Then
                            separator = " "
                            widthFlag = True
                            Flag = "b"
                        ElseIf labels3(j - 1).Text = "    Nothing" Then
                            separator = ""
                            widthFlag = True
                            Flag = "c"
                        ElseIf labels3(j - 1).Text = "    New Line" Then
                            separator = vbNewLine
                            widthFlag = True
                            Flag = "b"
                        Else
    ...
    Private Sub CheckBox5_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox5.CheckedChanged
        ...
        Try
            ...
            Else
                rng = workSheet.Range(rng.Cells(0, 1), rng.Cells(rng.Rows.Count, rng.Columns.Count))
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            If Active = True Then
                ...
                rng2 = workSheet2.Range(rng2.Cells(1, 1), rng2.Cells((UBound(Arr1) + 1), rng.Columns.Count))
                rng2Address = rng2.Address

                Dim UniQueArr() As Integer = GetUniques(rng, CaseSensitive)
                                ...
                                For i = 1 To rng.Rows.Count
                                    ...
                                    If widthFlag = True Then
                                        ...
                                        If ValueArr(i - 1, j - 1) IsNot Nothing And DuplicateCondition Then
                                            Dim Matched As Boolean
                                            If CheckBox1.Checked = True Then
                                                Matched = ValueArr(i - 1, PrimaryColumn - 1) = Arr1(k)
                                            Else
                                                Matched = LCase(ValueArr(i - 1, PrimaryColumn - 1)) = LCase(Arr1(k))
                                            End If
                                ...
                                For i = 1 To rng.Rows.Count
                                    ...
                                    If widthFlag = True Then
                                        If rng.Cells(i, j).Value IsNot Nothing And DuplicateCondition Then
                                            Dim Matched As Boolean
                                            If CheckBox1.Checked = True Then
                                                Matched = rng.Cells(i, PrimaryColumn).Value = Arr1(k)
                                            Else
                                                Matched = LCase(rng.Cells(i, PrimaryColumn).Value) = LCase(Arr1(k))
                                            End If

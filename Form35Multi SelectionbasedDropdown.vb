...
Public Class Form35Multi_SelectionbasedDropdown
        ...
        Else
            ...
            Else
                ...
                If TB_src_rng.Enabled = True Then
                    GB_CB_Source1 = TB_src_rng.Text 'SR is the global variable for Source Range
                Else
                    GB_CB_Source1 = src_rng.Address
                End If
                ...
                RangeType1 = CB_Source.Text

                TType1 = ""
                SR1 = CB_Source.Text
                shName1 = workSheet.Name
            End If
            ...
            workSheet2.Range("A9").Value = shName1

...
namespace VSTO_Addins
{
    ...
    public partial class Form23_Merge_Duplicate_Columns
    {
        ...
        public Form23_Merge_Duplicate_Columns()
        {
            InitializeComponent();
        }
        ...
        private object GetUniques(Range rng, bool CaseSensitive, bool RowWise)
        {
            ...
            else
            {
                ...
                bool Matched;
                for (int j = 2, loopTo3 = rng.Columns.Count; j <= loopTo3; j++)
                {
                    Matched = false;
                    for (int l = Information.LBound(Uniques), loopTo4 = Information.UBound(Uniques); l <= loopTo4; l++)
                    {
                        int count = 0;
                        for (int i = 1, loopTo5 = rng.Rows.Count; i <= loopTo5; i++)
                        {
                            ...
                            if (rng.Cells[i, Uniques[l]].value is null)
                            {
                                Type2 = typeof(string);
                            }
                            else
                            ...
                            if (Type1.Equals(Type2))
                            {
                                if (CaseSensitive == true)
                                {
                                    if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(rng.Cells[i, j].value, rng.Cells[i, Uniques[l]].value, false)))
                                    {
                                        count = count + 1;
                                    }
                                }
                                else if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(LCase(rng.Cells[i, j].value), LCase(rng.Cells[i, Uniques[l]].value), false)))
                                {
                                    count = count + 1;
                                }
                            }
                        }
                        if (count == rng.Rows.Count)
                        {
                            Matched = true;
                            break;
                        }
        ...
        private void Setup()
        {
            ...
            try
            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    ...
                    {
                        lbl.Text = Conversions.ToString(rng.Cells[i, 0].Value);
                    }
                    else
                    {
                        string rowLetter = Strings.Split(Conversions.ToString(rng.Cells[i, 1].Address((object)true, (object)true)), "$")[2];
        ...
        private void Display()
        {
            ...
            try
            {
                ...
                if (Active == true)
                {
                    ...
                    Range cRng;
                    cRng = workSheet.get_Range(displayRng.Cells[PrimaryRow, 1], displayRng.Cells[PrimaryRow, displayRng.Columns.Count]);
                    ...
                    {
                        for (int j = 1, loopTo = cRng.Columns.Count; j <= loopTo; j++)
                        {
                            if (cRng.Cells[1, j].Value is not null)
                            {
                                if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(Search(Arr1, cRng.Cells[1, j].Value, (object)CaseSensitive), false, false)))
                                {
                                    Index1 = Index1 + 1;
                                    Index2 = Index2 + 1;
                    ...
                    {
                        for (int j = 1, loopTo1 = cRng.Columns.Count; j <= loopTo1; j++)
                        {
                            if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(Search(Arr1, cRng.Cells[1, j].Value, (object)CaseSensitive), false, false)))
                            {
                                Index1 = Index1 + 1;
                    ...
                    {
                        width = (float)(CustomPanel2.Width / (double)(Information.UBound(Arr1) + 1));
                    }
                    else
                    {
                    ...
                    int[] UniQueArr = (int[])GetUniques(displayRng, CaseSensitive, false);
                        ...
                        if (i != PrimaryRow)
                        {
                            ...
                            for (int k = Information.LBound(Arr1), loopTo3 = Information.UBound(Arr1); k <= loopTo3; k++)
                            {
                                ...
                                for (int j = 1, loopTo4 = displayRng.Columns.Count; j <= loopTo4; j++)
                                {
                                    ...
                                    {
                                        DuplicateCondition = Conversions.ToBoolean(SearchInArray(UniQueArr, j));
                                    }
                                    else
                                    {
                                    ...
                                    if (displayRng.Cells[i, j].value is not null & DuplicateCondition)
                                    {
                                        ...
                                        if (CheckBox1.Checked == true)
                                        {
                                            Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(displayRng.Cells[PrimaryRow, j].value, Arr1[k], false));
                                        }
                                        else
                                        {
                                            Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(LCase(displayRng.Cells[PrimaryRow, j].value), LCase(Arr1[k]), false));
                                        }
                            ...
                            if (labels3[i - 1].Text == "    Comma")
                            {
                                separator = ", ";
                                widthFlag = true;
                                Flag = "a";
                            }
                            else if (labels3[i - 1].Text == "    Colon")
                            {
                                separator = ": ";
                                widthFlag = true;
                                Flag = "a";
                            }
                            else if (labels3[i - 1].Text == "    Semicolon")
                            {
                                separator = "; ";
                                widthFlag = true;
                                Flag = "a";
                            }
                            else if (labels3[i - 1].Text == "    Space")
                            {
                                separator = " ";
                                widthFlag = true;
                                Flag = "b";
                            }
                            else if (labels3[i - 1].Text == "    Nothing")
                            {
                                separator = "";
                                widthFlag = true;
                                Flag = "c";
                            }
                            else if (labels3[i - 1].Text == "    New Line")
                            {
                            ...
                            for (int k = Information.LBound(Arr1), loopTo5 = Information.UBound(Arr1); k <= loopTo5; k++)
                            {
                                ...
                                for (int j = 1, loopTo6 = displayRng.Columns.Count; j <= loopTo6; j++)
                                {
                                ...
                                label.Location = new System.Drawing.Point((int)Math.Round((k + 1 - 1) * width), (int)Math.Round(abscissa));
                                label.Width = (int)Math.Round(width);

                                if (widthFlag == true)
                                {
                                    label.Height = (int)Math.Round((Conversion.Int(max / 2d) + 1d) * (double)height);
                                ...
                                if (CheckBox4.Checked == true)
                                {
                                    ...
                                    Range cell = (Range)displayRng.Cells[i, Arr2[k]];
                                    var font = cell.Font;
                            ...
                            if (widthFlag == true)
                            {
                                abscissa = (float)((double)abscissa + (Conversion.Int(max / 2d) + 1d) * (double)height);
                            }
                            else
                            {
        ...
        private void Form23_Merge_Duplicate_Columns_Load(object sender, EventArgs e)
        {
        ...
        private void CheckBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (CheckBox5.Checked == true)
                {
                    rng = workSheet.get_Range(rng.Cells[1, 2], rng.Cells[rng.Rows.Count, rng.Columns.Count]);
                }
                else
                {
                    rng = workSheet.get_Range(rng.Cells[1, 0], rng.Cells[rng.Rows.Count, rng.Columns.Count]);
                }
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (Active == true)
            {
                ...
                Range cRng;
                cRng = workSheet.get_Range(rng.Cells[PrimaryRow, 1], rng.Cells[PrimaryRow, rng.Columns.Count]);
                ...
                rng2 = workSheet2.get_Range(rng2.Cells[1, 1], rng2.Cells[rng.Rows.Count, Information.UBound(Arr1) + 1]);
                rng2Address = rng2.get_Address();

                int[] UniQueArr = (int[])GetUniques(rng, CaseSensitive, false);
                                ...
                                for (int j = 1, loopTo10 = rng.Columns.Count; j <= loopTo10; j++)
                                {
                                    ...
                                    if (widthFlag == true)
                                    {
                                        ...
                                        if (ValueArr[i - 1, j - 1] is not null & DuplicateCondition)
                                        {
                                            ...
                                            if (CheckBox1.Checked == true)
                                            {
                                                Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(ValueArr[PrimaryRow - 1, j - 1], Arr1[k], false));
                                            }
                                            else
                                            {
                                                Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(LCase(ValueArr[PrimaryRow - 1, j - 1]), LCase(Arr1[k]), false));
                                            }
                ...
                else
                {
                    ...
                    for (int i = 1, loopTo12 = rng.Rows.Count; i <= loopTo12; i++)
                    {
                        if (i != PrimaryRow)
                        {
                            ...
                            for (int k = Information.LBound(Arr1), loopTo13 = Information.UBound(Arr1); k <= loopTo13; k++)
                            {
                                ...
                                for (int j = 1, loopTo14 = rng.Columns.Count; j <= loopTo14; j++)
                                {
                                    ...
                                    if (widthFlag == true)
                                    {
                                        if (rng.Cells[i, j].Value is not null & DuplicateCondition)
                                        {
                                            ...
                                            if (CheckBox1.Checked == true)
                                            {
                                                Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(rng.Cells[PrimaryRow, j].Value, Arr1[k], false));
                                            }
                                            else
                                            {
                                                Matched = Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(LCase(rng.Cells[PrimaryRow, j].Value), LCase(Arr1[k]), false));
                                            }
                                ...
                                if (CheckBox4.Checked == true)
                                {
                                    ...
                                    rng2.Cells[i, k + 1].PasteSpecial(XlPasteType.xlPasteFormats);
                    ...
                    for (int j = 1, loopTo16 = rng2.Columns.Count; j <= loopTo16; j++)
                    {
        ...
        private void Form23_Merge_Duplicate_Columns_Closing(object sender, CancelEventArgs e)
        {
            GlobalModule.form_flag = false;
        }

        private void Form23_Merge_Duplicate_Columns_Disposed(object sender, EventArgs e)
        {
            GlobalModule.form_flag = false;
        }

        private void Form23_Merge_Duplicate_Columns_Shown(object sender, EventArgs e)
        {
            Focus();
            BringToFront();
            Activate();

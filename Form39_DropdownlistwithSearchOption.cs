...
namespace VSTO_Addins
{
    ...
    public partial class Form39_DropdownlistwithSearchOption
    {
        ...
        public Form39_DropdownlistwithSearchOption()
        {
        ...
        private void Form39_DropdownlistwithSearchOption_Load(object sender, EventArgs e)
        {
            KeyPreview = true;
        ...
        private void sheet_SelectionChange(Range Target)
        {
            ...
            {
                src_rng = workSheet.get_Range(GlobalModule.GB_CB_Source3);
        ...
        private void Btn_OK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                GlobalModule.Flag3 = true;
                GlobalModule.GB_CB_Source3 = TB_src_rng.Text;
                ...
                foreach (var ws in workBook.Sheets)
                {
                    if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(ws.Name, "SoftekoSoftekoSofteko", false)))
                    {
                        ws.Delete();
                        break;
                    }
                ...
                workSheet2.Name = "SoftekoSoftekoSofteko";
                ...
                // workSheet2.Range("A2").Value = GB_CB_Source3
                // 'workSheet2.Range("A3").Value = SR3
                // 'workSheet2.Range("A4").Value = Horizontal1
                // ' workSheet2.Range("A5").Value = Separator1
                // ' workSheet2.Range("A6").Value = Search1
                // workSheet2.Range("A7").Value = Flag3
                // workSheet2.Range("A8").Value = TargetVar3
                // 'workSheet2.Range("A9").Value =
                // 'workSheet2.Range("A10").Value =

                // Public CB_Source As String
                // Public SR As String
                // Public Horizontal As Boolean
                // Public Separator As String
                // Public Search As Boolean
                // Public Flag As Boolean
                // Public TargetVar As Excel.Range
                ...
                {
                    GlobalModule.GB_CB_Source3 = TB_src_rng.Text; // SR is the global variable for Source Range
                }
                else
                {
                    GlobalModule.GB_CB_Source3 = src_rng.get_Address();
                }

                GlobalModule.GB_CB_Source3 = src_rng.get_Address();
                workSheet2.get_Range("A2").set_Value(value: GlobalModule.GB_CB_Source3);

                workSheet2.get_Range("B2").set_Value(value: CB_Source.Text);
                GlobalModule.RangeType3 = CB_Source.Text;

                GlobalModule.TType3 = "";
                GlobalModule.SR3 = CB_Source.Text;
                GlobalModule.shName3 = workSheet.Name;

                workSheet2.get_Range("A2").set_Value(value: GlobalModule.GB_CB_Source3);   // For Source Range
                workSheet2.get_Range("A3").set_Value(value: GlobalModule.SR3);             // Range Type
                                                                                           // workSheet2.Range("A4").Value = Horizontal2
                                                                                           // workSheet2.Range("A5").Value = Separator2
                                                                                           // workSheet2.Range("A6").Value = Search2
                workSheet2.get_Range("A7").set_Value(value: GlobalModule.Flag3);            // Activated
                workSheet2.get_Range("A8").set_Value(value: GlobalModule.TargetVar3);
                workSheet2.get_Range("A9").set_Value(value: GlobalModule.shName3);

                Close();
            }
        }

        private void GB_Sample_Enter(object sender, EventArgs e)
        {

        }

        private void Form39_DropdownlistwithSearchOption_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Form39_DropdownlistwithSearchOption_Closing(object sender, CancelEventArgs e)
        {
            GlobalModule.form_flag = false;
        }

        private void Form39_DropdownlistwithSearchOption_Disposed(object sender, EventArgs e)
        {
            GlobalModule.form_flag = false;
        }
    }

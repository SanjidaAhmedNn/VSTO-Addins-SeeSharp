...
namespace VSTO_Addins
{
    ...
    public partial class Form35Multi_SelectionbasedDropdown
    {
        ...
        public Form35Multi_SelectionbasedDropdown()
        {
        ...
        private void Btn_OK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (GlobalModule.settingflag1 == true)
                {

                    if (RB_Horizontal.Checked == true)
                    {
                        GlobalModule.Horizontal1 = true;
                    }
                    else
                    {
                    ...
                    GlobalModule.Flag1 = true;

                    GlobalModule.Separator1 = CB_Separator.Text;
                }
                ...
                else
                {
                    ...
                    GlobalModule.Flag1 = true;
                    GlobalModule.GB_CB_Source1 = TB_src_rng.Text;
                    GlobalModule.Separator1 = CB_Separator.Text;
                    ...
                    {
                        GlobalModule.GB_CB_Source1 = TB_src_rng.Text; // SR is the global variable for Source Range
                    }
                    else
                    {
                        GlobalModule.GB_CB_Source1 = src_rng.get_Address();
                    }

                    GlobalModule.GB_CB_Source1 = src_rng.get_Address();
                    // workSheet2.Range("A2").Value = GB_CB_Source1


                    GlobalModule.RangeType1 = CB_Source.Text;

                    GlobalModule.TType1 = "";
                    GlobalModule.SR1 = CB_Source.Text;
                    GlobalModule.shName1 = workSheet.Name;
                }
                ...
                workSheet2.get_Range("A2").set_Value(value: GlobalModule.GB_CB_Source1);   // For Source Range
                workSheet2.get_Range("A3").set_Value(value: GlobalModule.SR1);             // Range Type
                workSheet2.get_Range("A4").set_Value(value: GlobalModule.Horizontal1);
                workSheet2.get_Range("A5").set_Value(value: GlobalModule.Separator1);
                workSheet2.get_Range("A6").set_Value(value: GlobalModule.Search1);
                workSheet2.get_Range("A7").set_Value(value: GlobalModule.Flag1);            // Activated
                workSheet2.get_Range("A8").set_Value(value: GlobalModule.TargetVar1);
                workSheet2.get_Range("A9").set_Value(value: GlobalModule.shName1);
        ...
        private void sheet_SelectionChange(Range Target)
        {
            ...
            {
                src_rng = workSheet.get_Range(GlobalModule.GB_CB_Source1);
        ...
        private void Form35Multi_SelectionbasedDropdown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                Btn_OK.Focus();
        ...
        private void Form35Multi_SelectionbasedDropdown_Shown(object sender, EventArgs e)
        {
            TB_src_rng.Focus();
            // TB_src_rng.Focus()
            Focus();
        ...
        private void Form35Multi_SelectionbasedDropdown_Closing(object sender, CancelEventArgs e)
        {
            GlobalModule.form_flag = false;
        }

        private void Form35Multi_SelectionbasedDropdown_Disposed(object sender, EventArgs e)
        {
            GlobalModule.form_flag = false;
        }
    }

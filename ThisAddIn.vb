...
Public Class ThisAddIn
    ...
    Public Sub worksheet5_2_Change(ByVal Target As Excel.Range)
        ...
        ElseIf Target.Worksheet.Name = targetWorksheet.Range("C11").Value And excelApp.Intersect(Target, r13) IsNot Nothing Then
        ...
        ElseIf Target.Worksheet.Name = targetWorksheet.Range("D11").Value And excelApp.Intersect(Target, r14) IsNot Nothing Then
        ...
        ElseIf Target.Worksheet.Name = targetWorksheet.Range("E11").Value And excelApp.Intersect(Target, r15) IsNot Nothing Then
